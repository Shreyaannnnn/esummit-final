...
const battle = () =>{
    return(
      ...
      <div className="body">
        ...
        <a href="https://forms.gle/uQD73MvsYsiY6Lyc6">Register now</a>
      </button>
        ...
        <div>
          ...
          <p>Date: 13th March 2024</p>
<p>Time: 3:30-5:30 pm</p>

<p>Entry Fees: FREE for All (Team consists of 2 members)</p>

<p>CERTIFICATES WILL BE GIVEN TO ALL THE PARTICIPANTS  &  EXCITING PRIZES TO THE WINNERS🏆💰💸</p>
        </div>
        <div>
          <span><h2>REGISTRATION LINK</h2></span>
          <button className='button-73'>
        <a href="https://docs.google.com/forms/d/e/1FAIpQLScRLs_vPjzynn4X9Xl7lHBls1nBnaAGnxFvBXpO9hDRsrCzCA/viewform">Register now</a>
      </button>
        </div>
      </div>
    </div>
